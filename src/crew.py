...
async def run_atendimento(numero_whatsapp: str, mensagem: str, origem: str = "organico") -> str:
    ...
    task_wholesale = Task(
        description=(
            ...
            f"3) O site {site_url} (você redireciona o cliente para lá; NÃO afirma o conteúdo do site sem que esteja aqui no prompt).\n"
            ...
            "- Para virar lojista (preço de atacado): cadastro de revendedor no site; "
            "análise em até 48h, geralmente sai antes.\n"
